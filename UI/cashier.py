...
class App(tk.Tk):
  ...
  def initializeHomePage(self):
    self.paddedFrame = tk.Frame(self, bg="#ffffff")
    self.paddedFrame.pack(expand=True, fill="both", padx=20, pady=20)

    self.sidebarFrame = tk.Frame(self.paddedFrame, bg="#3498db")
    self.menuFrame = tk.Frame(self.paddedFrame, bg="#49a3df")
    self.summaryFrame = tk.Frame(self.paddedFrame, bg="#5faee3")
